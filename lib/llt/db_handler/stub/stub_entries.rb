...
class LLT::DbHandler::Stub::StubEntries
  class << self
    ...
    def medium_setup
      ...
      wsr(type: :noun,      nom: "iactatio",  stem: "iactation",  itype: 3, sexus: :f)
      wsr(type: :noun,      nom: "iuvenis",   stem: "iuven",      itype: 3, sexus: :m)
      wsr(type: :noun,      nom: "sanguis",   stem: "sanguin",    itype: 3, sexus: :m)
      wsr(type: :noun,      nom: "finis",     stem: "fin",        itype: 33, sexus: :f)
      wsr(type: :noun,      nom: "civis",     stem: "civ",        itype: 33, sexus: :m)
      ...
      wsr(type: :adjective, nom: "praecipuus",stem: "praecipu",   itype: 1, number_of_endings: 3)
